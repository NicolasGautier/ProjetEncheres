            ...
            <legend><h2>Retrait</h2></legend>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2"><c:if test="${newArtModel.annulerVente}"><button class="btn-secondary btn-lg btn-block" type="submit" name="annulerLaVente" value="annulerLaVente">Annuler la vente</button>
                        </c:if></div>
                        <div class="col-3"></div>
                    </div>
